...
export class ContactController {
  ...
  @UseGuards(JwtAuthGuard)
  async getKanban() {
    return this.contactService.getKanban();
  }

  @Get('/filter/all')
  @UseGuards(JwtAuthGuard)
  async filterByAll(@Query() query: any) {
    return this.contactService.filterByAll(query.status, query.search);
  }


  // @Get('/filter/:id')
  // @UseGuards(JwtAuthGuard)
  // async filterByAll(@Param() param: IdParamDto) {
  //   return this.contactService.filterByAll(param.id);
  // }
}
